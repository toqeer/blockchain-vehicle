    ...
    return (
      <Menu text className="topbar" size="massive">
        ...
        <Menu.Item className="brand">
          <img src={require('../../../assets/images/Icons/brand-icon.png')} alt="brand-icon" />
          <span>Vehicle Registeration Managment</span>
        </Menu.Item>
        <Menu.Menu position="right">
          <Menu.Item className="profile-wraper">
            <Image size="mini" circular src={require('../../../assets/images/Icons/icon-user.png')} />
            <span>{email}</span>
          </Menu.Item>
          <Menu.Item className="logout-wraper" onClick={this.handleLogout}>
            <Image size="mini" circular src={require('../../../assets/images/Icons/icon-logout.png')} />
            <span>logout</span>
          </Menu.Item>
        </Menu.Menu>
      </Menu>
...
const mapStateToProps = (state) => {
  ...
  // return { key };
  return{
    email: state.userAuth.user && state.userAuth.user.data.mId,
  }
};
