...
const Transections = props => {
  ...
  useEffect(() => {
    props.getAllMinistoryTransactions();
  }, []);
...
const mapStateToProps = state => ({
  transections: state.interiorMinitory.allTransactions,
  loading: state.interiorMinitory.transactionsLoading,
