...
async function unRevokeLicense(req,res) {
    ...
    var options = {
        method: 'POST',
        url: 'http://localhost:3000/api/org.license.UnRevokeLicense',
        headers: {'content-type': 'application/json'},
        body: {
            "$class": "org.license.UnRevokeLicense",
    ...
    request(options, function (error, response, body) {
        ...
        var obj = {
            ...
            transactionType : "UnRevokeLicense",
            transactionInvoked : "org.license.UnRevokeLicense#"+body.transactionId,
            timestamp : new Date().toISOString()
        };
        postHistorian.postHistorian(obj);

        var result= {success: true, result: {message: "License Unrevoked Successfully" , trxId: body.transactionId}};
